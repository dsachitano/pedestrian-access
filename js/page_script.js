 ...
 * Notice the grouping.  If we wanted,
 * we could color these markers to provide
 * greater detail.  But the simpler view
 * is to just have 2 colors and grey.
 */
...
/**
 * Compute colors for grid cells.  These values
 * are based off of the style categorization 
 * generated by QGIS, I just copied the cutoff
 * lenght values, and used a color ramp from
 * color brewer
 */
